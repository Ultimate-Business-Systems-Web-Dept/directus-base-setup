...
RUN sed -i 's/\r$//' /directus/docker-entrypoint.sh \
    && chown -R node:node /directus/extensions /directus/uploads /directus/snapshot /directus/docker-entrypoint.sh \
    && find /directus/extensions /directus/uploads /directus/snapshot -type d -exec chmod 755 {} \; \
    && find /directus/extensions /directus/uploads /directus/snapshot -type f -exec chmod 644 {} \; \
